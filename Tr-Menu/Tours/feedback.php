...
if(isset($_POST['submit']))
  {
  	$eid=$_GET['editid'];
  	//Getting Post Values
	$trfeedback=$_POST['trfeedback'];

    //Query for data updation
     $query=mysqli_query($conn, "update booking set tr_feedback='$trfeedback' where bk_id='$eid'");
		...
		<div class="update-form">
			...
			?>
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="trfeedback" required ></textarea>        	
				</div>
