...
if(isset($_POST['submit']))
  {
  	$eid=$_GET['editid'];
	$taccept=$_POST['taccept'];

    //Query for data updation
     $query=mysqli_query($conn, "update booking set t_accept='$taccept' where bk_id='$eid'");
     
    if ($query) {
		echo '<script>alert("Successfully Updated!"); window.location = "../dashboard.php";</script>'; 
  }
  else
    {
		...
		<div class="update-form">
			...
			?>
				...
				<div class="form-group">
                    <span>Do You Accept This Tour?</span>
					<input type="text" class="form-control" name="taccept" required="true">       	
				</div>
