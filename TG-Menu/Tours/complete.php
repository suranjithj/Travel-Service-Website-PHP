...
if(isset($_POST['submit']))
  {
  	$eid=$_GET['editid'];
  	//Getting Post Values
	$tgconfirm=$_POST['tgconfirm'];

    //Query for data updation
     $query=mysqli_query($conn, "update booking set tg_confirm='$tgconfirm' where bk_id='$eid'");
		...
		<div class="update-form">
			...
			?>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="tgconfirm" required="true">       	
				</div>
