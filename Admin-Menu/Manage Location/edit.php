	...
	<body>
		<div class="update-form">
			...
			?>
				...
				<div class="form-group">
					<textarea class="form-control" name="description2" required="true"><?php  echo $row['description2'];?></textarea>
				</div>
			...
			<?php 
				...
				<div class="text-center"><a href="managelocation.php" class="back">Back</a></div>
			</form>
